...
ControlComponent *createSquareByToolType(Window *window, ControlComponent *ccp, Coord crd, eTool type, int player, btnFunc f)//int (*f)(Window *, ControlComponent *))
{
	ControlComponent *ccb=NULL;
